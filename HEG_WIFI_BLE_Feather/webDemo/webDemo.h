...
<body>
  ...
  <script>
    //Rough Draft scripts. Generalize the overlays, onData, replayCSV, and handleEventData calls
    ...
    var modeHTML = '<div class="menudiv" id="menudiv"> \
      Modes:<br> \
      <button class="button cvbutton" id="canvasmode">Circle</button><button class="button vdbutton" id="videomode">Video</button><button class="button aubutton" id="audiomode">Audio</button><br> \
